$(document).ready(function() {
    ...
    if( location.href == "file:///D:/html_templates/bolsanova/index.html" || location.href == "http://bolsanova.com.ar" || location.href == "http://www.bolsanova.com.ar")
    {
        ...
        $('#nuevo').addClass('animated bounceInUp');
        $('#carrito1').addClass('delay1 animated bounceInDown');
        $('#carrito2').addClass('delay2 animated bounceInDown');
        $('#carrito3').addClass('delay3 animated bounceInDown');
        $('#carrito4').addClass('delay4 animated bounceInDown');
    }
